...
//     });
//
export const getYoutubeDescriptionResponse = webMethod(
    Permissions.Anyone,
    async (videoDescription, videoDescriptionOptions) => {
        ...
        const callMyBackendPOST = async () => {
            const res = await httpClient.fetchWithAuth(
                `${import.meta.env.BASE_API_URL}/api/open-ai-api`,
                {
                    method: "POST",
...
const getYouTubeVideoDescription = async (videoDescription:string, videoDescriptionOptions:string) => {
...
const getYouTubeDescriptionResponse = async (videoDescription:string, videoDescriptionOptions:string) => {
