 ...
 */
const getYoutubeClient = (oAuth2Client) => {
    try {
 ...
 */
const getFirstChannelInfoFromYoutube = async (youtube) => {
    ...
    try {
        ...
        const retrievedChannel = new Promise((resolve, reject) => {
            return youtube.channels.list(listChannelParams, function (err, response) {
 ...
 * @returns {Promise<any>}
 */
export const updateChannels = async (oAuth2Client) => {
    try {
 ...
 * @returns {Promise<any>}
 */
export const getYouTubeDescriptionResponse = async (videoDescription, videoDescriptionOptions) => {
