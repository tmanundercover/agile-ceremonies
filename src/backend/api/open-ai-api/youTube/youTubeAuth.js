 ...
 */
export const createOauth2Client = async (client_id, access_token) => {
    try {
        ...
        const oAuth2Client = new google.auth.OAuth2(client_id, secret, encodeURI(redirectUrl));
 ...
 */
export const getAuthorizationUrl = async (oAuth2Client) => {
    try {
 ...
 */
export const getSecretSecret = async () => {
    try {
 ...
 */
export const getClientIdSecret = async () => {
    try {
        console.info('Retrieving client ID');
        const client_id = await secrets.getSecretValue("youtube-api-client-id");
 ...
 */
export const storeAccessTokens = async (code) => {
 ...
 */
export const getAccessTokenFromHeader = async (authorizationHeader) => {
    try {
