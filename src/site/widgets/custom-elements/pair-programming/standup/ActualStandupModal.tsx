...
import {HelpRequest, StandupData, StandupModalProps, Task} from './types';
...
const ActualStandupModal: React.FC<StandupModalProps> = ({
    ...
    const [tasksInProgress, setTasksInProgress] = useState<Partial<Task>[]>([{
        id: '1',
        title: '',
        status: 'In Progress'
    }]);
